...
public class NaverManager {
  ...
  public List<String> getMovieCodeData()
  {
	  ...
	  try
	  {
		      ...
		      for(int j=1;j<=12;j++)
		      {
		        	...
		        	Document doc=Jsoup.connect("http://movie.naver.com/movie/sdb/rank/rmovie.nhn?sel=pnt&date=20170601&page="+j).get();
  ...
  {
	  List<NaverMovieVO> list=
			  new ArrayList<NaverMovieVO>();
	  try
	  {
		  ...
		  {
			  if(i==166||i==210||i==213||i==245||i==394||i==430||i==539||i==550||i==559||i==582)continue;
